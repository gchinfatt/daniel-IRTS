...
namespace DanielIncidentReporting.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        private ActionResult RedirectToLocal(string v1, string v2)
        {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            //pasted try/catch here to eliminate break when registering 'Risk Manager' with no program selected 3/25
            try
            {
                List<SelectListItem> list = new List<SelectListItem>();
                list.Add(new SelectListItem { Value = "", Text = "Program Name", Selected = true, Disabled = true });
